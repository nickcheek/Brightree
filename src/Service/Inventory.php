...
class Inventory extends BaseService
{
	protected array $methods = [
		...
		'ItemMaintenanceAddTracking' => true,
		'ItemMaintenanceFetchByBrightreeID' => true,
		'ItemMaintenanceNoteCreate' => true,
		'ItemMaintenanceReasonFetchAll' => [],
		'ItemMaintenanceUpdate' => true,
		...
		'ItemSearchWithDetails' => true,
		'ItemLocationsUpdate' => true,
		'ItemLocationUpdate' => true,
		'ItemSearch' => true,
		'ItemUpdate' => true,
		'KitTypeFetchAll' => [],
		'LocationFetchByBrightreeID' => true,
		'ManufacturerInfoFetchAll' => [],
		'NDCFetchAll' => [],
		'StockingUOMFetchAll' => []
	];
