...
class Patient
{
	...
	public function __construct()
	{
		...
		$this->patient = $config->service['patient'];
		$this->patient_options = array('login' => $config->user['name'],'password' => $config->user['pass'],'uri' => $this->patient,'location' => $this->patient,'trace' => 1);
	}
