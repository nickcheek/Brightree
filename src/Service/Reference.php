...
class Reference extends BaseService
{
	protected array $methods = [
		...
		'FacilityNoteCreate' => true,
		'FacilityNoteFetchByBrightreeID' => true,
		'FacilityNoteFetchByFacility' => true,
		'FacilityNoteReasonFetchAll' => [],
		'FacilityNoteUpdate' => true,
		'FacilityReferralContactsFetchByFacilityKey' => true,
		'FacilityUpdate' => true,
		'FetchCurrentSecUser' => [],
		'FinancialNoteReasonFetchAll' => [],
		...
		'ItemStatusFetchAll' => [],
		'ItemTypesFetchAll' => [],
		'JustificationNoteReasonFetchAll' => [],
		...
		'PatientSecurityGroupFetchAll' => [],
		'PlaceOfServiceFetchAll' => [],
		'PolicyClaimCodeFetchAll' => [],
		'PolicyTypeCodeFetchAll' => [],
		'PickupExchangeReasonFetchAll' => [],
		'PractitionerInfoFetchAll' => [],
		'PractitionerNoteReasonFetchAll' => [],
		'ProgressNoteReasonFetchAll' => [],
